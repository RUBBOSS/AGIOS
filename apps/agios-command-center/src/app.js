...
function renderIntegrations() {
  ...
  const connectionDecisions = [
    ...
    ["Pokee", "approval", "Account signed in · API key pending", "You are logged in at pokee.ai. Create an API key in the dashboard and paste it here, then the sandbox route can be wired."],
