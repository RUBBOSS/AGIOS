...
from agios.operational import OperationalError, OperationalService, run_codex_cli
...
class Phase4BStoresTests(unittest.TestCase):
    ...
    def test_runtime_catalog_is_truthful_and_path_free(self):
        ...
        items = collect_runtime_catalog(systems, executable_finder=lambda name: f"C:/private/{name}" if name.split(".")[0] in found else None)
